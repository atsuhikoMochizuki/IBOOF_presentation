...
import static fr.diginamic.services.subSystems.Cleaner.filtrer;
...
public class CleanerTest extends TestCase {
    ...
    public String COMPLETE_CSV_FILE_PATH = ResourceBundle.getBundle("project").getString("project.csvfile");
